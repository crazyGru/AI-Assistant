...
export default function Sidebar() {
  ...
  return (
    <>
      <nav className="left-0 flex-row shadow-xl bg-white z-10 py-4 px-6" style={{minWidth:"257px",height: "calc(100vh - 82px)",position: "fixed", top: "82px"}}>
        <div className="min-h-full px-0 flex flex-wrap  justify-between w-full mx-auto">
