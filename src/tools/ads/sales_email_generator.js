...
const obj = {
	...
	desc: "Generate cold email for sales",
	category: "Ads",
	Icon: EyeIcon,
	// tags: [],
	permissions: ['user'],
	...
	to: "/ai/ads/sales_email_generator",
	api: "/ai/ads/sales_email_generator",
	...
	prompts: [{
		...
		prompts: [
			...
			},
            {
				...
				attr:"problem",
				value:"",
				placeholder:"What problems your product solving?",		
				maxLength: 400,
                type:"textarea",
				// max: 100,
				min: 3,
