...
const obj = {
	...
	desc: "Write short, simple and informative points for the subheadings of your article.",
	category: "Article",
	Icon: ViewListIcon,
	// tags: [],
	permissions: ['user'],
	...
	to: "/ai/blog/talking_points",
	api: "/ai/blog/talking_points",
		...
		prompts: [
			{
				...
				attr: "title",  
				value: "", 
				placeholder: "Best restaurants in Japan", 
				label: "",
				// type: "textarea",
				maxLength: 50,
				// max: 100,
			...
			},
			{
				...
				attr:"subheading",
				value:"",
				placeholder:"Subheading 1, subheading 2",
				type: "textarea",
				maxLength: 200,
				// max: 100,
				min: 3,
